...
const categories = [
  ...
  { title: "Cuidados com a Pele", descri: "Produtos para cuidados com a pele", index: 3, request: '/mostrarprodutoportipo/pele' },
  { title: "Pincéis", descri: "Pincéis de maquiagem", index: 4, request: '/mostrarprodutoportipo/pinceis' },
  { title: "Boca", descri: "Produtos para os lábios", index: 5, request: '/mostrarprodutoportipo/boca' },
  { title: "Pó", descri: "Pó de maquiagem", index: 6, request: '/mostrarprodutoportipo/po' },
